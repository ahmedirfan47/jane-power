  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-md">
        ...
        <p className="mb-1 text-[15px] font-medium text-ink">The market, on one screen.</p>
        <p className="mb-8 text-sm leading-relaxed text-mute">
          Live multi-chart workspace, macro sessions, and a real-time tape — built
          for traders who watch everything at once.
        </p>

        {user ? (
          <Link
            href="/terminal"
            className="block w-full rounded-lg bg-gold px-4 py-3 text-center text-sm font-semibold text-void transition hover:bg-gold-hi"
          >
            Enter terminal
          </Link>
        ) : (
          <>
            <Link
              href="/terminal"
              className="mb-3 block w-full rounded-lg bg-gold px-4 py-3 text-center text-sm font-semibold text-void transition hover:bg-gold-hi"
            >
              Open live terminal
            </Link>
